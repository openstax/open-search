...
module Api::V0::Bindings
  class SearchResult
    # How long the request took inside OpenSearch, including 'took' (ms)
    attr_accessor :overall_took

    # How long the request took inside OpenSearch (ms)
    attr_accessor :took

    # Whether the request in OpenSearch timed out
    attr_accessor :timed_out

    # Shard stats from OpenSearch
